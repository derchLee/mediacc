...
export const ui: UiT = {
  ...
  tooManyFiles: "Você pode selecionar até {max} arquivos. Já há {current} arquivo(s) selecionado(s).",
  fileTooLarge: "Cada arquivo deve ter no máximo {max} MB.",
  totalSizeTooLarge: "O tamanho total não pode exceder {max} MB. Já há {current} MB selecionados.",
  fileTypeMismatch: "{count} arquivo(s) selecionado(s) não têm um formato compatível.",
  uploadSuccess: "Arquivos adicionados com sucesso. Continue na área de uploads para converter ou comprimir.",
  continueProcessing: "Continuar para uploads",
  close: "Fechar",
  cookieSettings: "Configurações de cookies",
  cookiesTitle: "Usamos cookies",
  cookiesDescription: "Usamos cookies para melhorar sua experiência e analisar o tráfego do site.",
  learnMore: "Saiba mais",
  acceptAll: "Aceitar todos",
  rejectAll: "Rejeitar todos",
  customize: "Personalizar",
  necessaryCookies: "Cookies necessários",
  necessaryCookiesDesc: "Necessários para o funcionamento correto do site",
  analyticsCookies: "Cookies analíticos",
  analyticsCookiesDesc: "Ajudam a entender como o site é utilizado",
  advertisingCookies: "Cookies de publicidade",
  advertisingCookiesDesc: "Usados para exibir anúncios relevantes",
  savePreferences: "Salvar preferências",
  unexpectedError: "Ocorreu um erro",
  retry: "Tentar novamente",
  pageNotFound: "Página não encontrada",
  pageNotFoundDesc: "A página solicitada não existe.",
...
export const imagePage: ImagePageT = {
  ...
  tutorialTitle: "Exemplo animado de conversão e compressão de imagens",
  tutorialDescription: "Siga este exemplo animado para adicionar imagens, escolher o formato ou modo de compressão, processar localmente e baixar os resultados.",
...
export const videoPage: VideoPageT = {
  ...
  tutorialTitle: "Exemplo animado de conversão de vídeo",
  tutorialDescription: "Siga este exemplo animado para adicionar vídeos, escolher o formato de destino, iniciar a conversão local e baixar cada arquivo concluído.",
  detailedGuide: "Guia de uso detalhado",
  howToUse: "Como usar",
  formatConversion: "1. Conversão de formato",
  formatConversionList: [
...
function buildVideoLayoutMeta(): VideoLayoutMetaT {
  ...
  return {
    title: "Conversor de vídeo grátis (local)",
    description:

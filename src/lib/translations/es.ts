...
function buildImageLayoutMeta(): ImageLayoutMetaT {
  ...
  return {
    ...
    softwareApp: {
      ...
      description:
        "Convertidor y compresor de imágenes gratis que procesa todo en el navegador sin subir a ningún servidor. Convierte entre JPG, PNG, WebP, AVIF y reduce el tamaño.",
      url,
      downloadUrl: url,
      inLanguage: "es",
...
function buildVideoLayoutMeta(): VideoLayoutMetaT {
  ...
  return {
    ...
    softwareApp: {
      ...
      description:
        "Convertidor y compresor de vídeo gratis con FFmpeg.wasm. Procesa todo en el navegador sin subir a ningún servidor. Convierte entre MP4, WebM, MOV, MKV, AVI.",
      url,
      downloadUrl: url,
      inLanguage: "es",
      isAccessibleForFree: true,

...
export const ui: UiT = {
  ...
  tooManyFiles: "選択できるファイルは最大{max}件です。現在{current}件選択されています。",
  fileTooLarge: "1ファイルのサイズは{max}MB以下にしてください。",
  totalSizeTooLarge: "合計サイズは{max}MB以下にしてください。現在{current}MB選択されています。",
  fileTypeMismatch: "選択したファイルのうち{count}件は対応形式ではありません。",
  uploadSuccess: "ファイルを追加しました。アップロード操作エリアで変換または圧縮を続けてください。",
  continueProcessing: "アップロード操作へ進む",
  close: "閉じる",
  cookieSettings: "Cookie設定",
  cookiesTitle: "Cookieを使用しています",
  cookiesDescription: "利便性の向上とアクセス解析のためにCookieを使用します。",
  learnMore: "詳細を見る",
  acceptAll: "すべて許可",
  rejectAll: "すべて拒否",
  customize: "設定を変更",
  necessaryCookies: "必須Cookie",
  necessaryCookiesDesc: "ウェブサイトの正常な動作に必要です",
  analyticsCookies: "分析Cookie",
  analyticsCookiesDesc: "サイトの利用状況を把握するために使用します",
  advertisingCookies: "広告Cookie",
  advertisingCookiesDesc: "関連性の高い広告を表示するために使用します",
  savePreferences: "設定を保存",
  unexpectedError: "エラーが発生しました",
  retry: "もう一度試す",
  pageNotFound: "ページが見つかりません",
  pageNotFoundDesc: "指定されたページは存在しません。",
  backHome: "ホームへ戻る",
...
export const imagePage: ImagePageT = {
  ...
  tutorialTitle: "画像変換・圧縮の操作例（アニメーション）",
  tutorialDescription: "複数画像の追加、出力形式または圧縮モードの選択、ローカル処理、結果のダウンロードまでをアニメーションで確認できます。",
...
export const videoPage: VideoPageT = {
  ...
  tutorialTitle: "動画形式変換の操作例（アニメーション）",
  tutorialDescription: "動画の追加、出力形式の選択、ローカル変換の開始、処理済みファイルのダウンロードまでをアニメーションで確認できます。",
  detailedGuide: "詳細な使い方ガイド",
  howToUse: "使い方",
  formatConversion: "1. 形式変換",
  formatConversionList: [
